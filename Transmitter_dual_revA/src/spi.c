...
void spi_setup_master(void){
  ...
  PORTC_PCR4 = PORT_PCR_MUX(1) | PORT_PCR_SRE | PORT_PCR_DSE; // CSn nRF24
  GPIOC_PDDR |= _BV(4); 

  //PORTD_PCR6 = PORT_PCR_MUX(1) | PORT_PCR_SRE | PORT_PCR_DSE; // CSn DAC
  //GPIOD_PDDR |= _BV(6); 
  ...
  /* PTC5, SPI0_SCK, ALT2 */
  PORTC_PCR5 = PORT_PCR_MUX(2) | PORT_PCR_SRE | PORT_PCR_DSE; // nRF24
  //PORTD_PCR1 = PORT_PCR_MUX(2) | PORT_PCR_SRE | PORT_PCR_DSE; // DAC
